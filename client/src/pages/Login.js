              ...
              <Form>
                <Form.Row>
                  <Form.Group as={Col} controlId="formGridEmail">
                    ...
                    <Form.Control onChange={onChange} name="email"  type="email" placeholder="Email*" />
                  </Form.Group>
                ...
                <Form.Group controlId="formGridAddress1">
                  ...
                  <Form.Control onChange={onChange}  name="name"  placeholder="Name*" />
                </Form.Group>

                <Form.Group controlId="formGridAddress1">
                  <Form.Label>Age</Form.Label>
                  <Form.Control onChange={onChange}  name="age"  placeholder="Age" />
                </Form.Group>

                <Form.Group controlId="formGridAddress2">
                  <Form.Label>Weight</Form.Label>
                  <Form.Control onChange={onChange} name="weight"  placeholder="Weight" />
                </Form.Group>
